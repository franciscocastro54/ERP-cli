    ...
    <body >
        <div class="container-fluid">
         ...
         <div class="col-2 text-center">
             <a class="" href="Modulos_control?m=cli"><img src="imagenes/log-small.jpeg" width="64px" height="64px">
                 <p>Clientes</p>
             </a>
             </div>
             <div class="col-2 text-center">
             <a class="" href="Modulos_control?m=ven"><img src="imagenes/log-small.jpeg" width="64px" height="64px">
                 <p>Ventas</p>
             </a>
             </div>
             <div class="col-2 text-center">
             <a class="" href="Modulos_control?m=com"><img src="imagenes/log-small.jpeg" width="64px" height="64px">
                 <p>Compras</p>
             </a>
             </div>
             <div class="col-2 text-center">
             <a class="" href="Modulos_control?m=inv"><img src="imagenes/log-small.jpeg" width="64px" height="64px">
                 <p>Inventario</p>
             </a>
             </div>
         <div class="col-2 text-center">
             <a class="" href="Modulos_control?m=fin"><img src="imagenes/log-small.jpeg" width="64px" height="64px">
                 <p>Finanzas</p>
             </a>
             </div>
         </div>
